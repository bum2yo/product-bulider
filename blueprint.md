# industry 5.0.1 - Introduction Page

## Overview
This project is a minimalist, single-page website with a terminal-like aesthetic for "industry 5.0.1". It features a dark/light mode toggle and a popup contact form integrating with Formspree.
...
- **Cleanup:** Removed unused external CSS/JS files.
- **Enhancement:** Added snow animation, dark mode, and contact form.
- **Feature:** Added "Hello" popup (Removed in later revision).
